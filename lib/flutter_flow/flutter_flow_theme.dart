...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF580013);
  late Color secondary = const Color(0xFFF70D00);
  late Color tertiary = const Color(0xFFFFC72C);
  late Color alternate = const Color(0xFFC4D600);
  ...
  late Color accent1 = const Color(0xFF6D6E71);
  late Color accent2 = const Color(0xFF8F1D1D);
  late Color accent3 = const Color(0xFF2E8540);
  late Color accent4 = const Color(0xFF1C4587);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color alternate = const Color(0xFFA4B300);
  ...
  late Color accent1 = const Color(0xFFB0B1B3);
  late Color accent2 = const Color(0xFF5C0C0C);
  late Color accent3 = const Color(0xFF1D5A2C);
  late Color accent4 = const Color(0xFF123264);
